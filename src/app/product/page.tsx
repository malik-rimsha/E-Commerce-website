...
interface Product {
  ...
  title: string;
  price: number;
  // Yahan priceWithoutDiscount add kiya hai jo Sanity se match karega
...
export default function AllProduct() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      // Query mein 'priceWithoutDiscount' ko shamil kiya gaya hai
      const data = await client.fetch(`*[_type == "products"]{
        _id,
        title,
        price,
          ...
          <div key={product._id} className="group relative flex flex-col h-full bg-white border border-gray-100 rounded-xl p-3 hover:shadow-2xl transition-all duration-300">
            ...
            <div className="mt-4 flex flex-col flex-grow">
              ...
              <div className="mt-2 flex items-center gap-2">
                ...
                {/* Fixed: Displaying Price Without Discount (Original Price) */}
